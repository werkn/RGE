 ...
 * Ryan Radford (ryan@werkncode.net) / Various Modifcations for Embedded Usage
 ******************************************************************************/
...
/* FUNCTION
 *      arraystack_get_pointer
 *
 * DESCRIPTION
 *      Gets the point for element at the specified position (effectively a reference).
 *
 * PARAMETERS
 *      s           A valid pointer to an initialized arraystack_t struct.
 *      pos         The position of the element that will be retrieved.
 */
extern void* arraystack_get_pointer(arraystack_t* stack, int index);
